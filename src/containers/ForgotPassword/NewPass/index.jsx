          ...
          >
            {({
              ...
              <form onSubmit={handleSubmit}>
                ...
                <label>Enter your new password. The new password must meet the below requirements:</label>
                <ul className={s.listCondition}>
                  ...
                  <li>Contain at least one numeric, one symbol, and must have at least 8 characters.</li>
                </ul>
                <input
                  type={checkToggle}
                  name="password"
                ...
                /><AiOutlineEye onClick={onTogglePass} className={s.iconEye} size={18.5} color="#BDBDBD" />
